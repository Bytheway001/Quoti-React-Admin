...
class FileNew extends React.Component {
    ...
    handleSubmit=(e)=>{
        ...
        Axios.post('http://quotyapi.megabrokerslatam.co/api/cloud',formData,{ headers: {...APIHEADERS,'Content-Type': 'multipart/form-data'} }).then(res=>res.data)
        .then(result=>{
            if(!result.errors){
        ...
        return (
                ...
                <Row style={{ padding: 30 }}>
                    ...
                    <Col xs={6}>
                        <FormGroup>
                            <label htmlFor="">Categoria</label>
                            <FormControl name='file' type='file' onChange={this.handleChange}/>
                        </FormGroup>
